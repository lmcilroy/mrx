...
void
mrx_hash_64_start_seed(mrx_hash_64_state_t * const state, const uint64_t seed)
{
	state->x1 = k2 ^ seed;
	state->x2 = k3 ^ seed;
	state->x3 = k4 ^ seed;
...
void
mrx_hash_64_start(mrx_hash_64_state_t * const state)
{
	mrx_hash_64_start_seed(state, 0);
}

void
mrx_hash_64_update(mrx_hash_64_state_t * const state, const void * const data,
    const size_t len)
{
...
void
mrx_hash_64_end(mrx_hash_64_state_t * const state, mrx_hash_64_t * const hash)
{
...
void
mrx_hash_64(const void * const data, const size_t len,
